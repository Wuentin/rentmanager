					...
					<div class="col-md-12">
						...
						<div class="box">
							...
							<form class="form-horizontal" method="post"
								action="/rentmanager/rents/create">
								<div class="box-body">
										...
										<div class="col-sm-10">
											<select class="form-control"  name="vehicle_id">
												<c:forEach items="${vehicles}" var="vehicle">
													<option value="${vehicle.id}">${vehicle.constructeur} avec 
														${vehicle.nbPlaces} places</option>
										...
										<div class="col-sm-10">
											<select class="form-control"  name="client_id">
												<c:forEach items="${clients}" var="client">
													<option value="${client.idClient}">${client.nom} 
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<!-- <input type="date" class="form-control" id="begin"
												name="begin" required data-inputmask="'alias': 'dd/mm/yyyy'"
												data-mask> -->
